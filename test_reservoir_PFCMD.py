...
class PFCMD():
    def __init__(self,PFC_G,PFC_G_off,learning_rate,
        ...
        self.modular  = False               # Assumew PFC modules and pass input to only one module per tempral context.
        ...
        self.MDlearningRate = 0.            # controls the LR of the Hebbian 
    ...
    def train(self,Ntrain):
        ...
        for traini in tqdm.tqdm(range(Ntrain)):
            ...
            if self.debug and (traini ==400): print('400 reached') # to use as a debugging breakpoint mid simulation.
