...
class PFCMD():
    def __init__(self,PFC_G,PFC_G_off,learning_rate,
        ...
        if self.reinforce:
            ...
            self.reinforceReservoir = True # learning on reservoir weights also?
...
if __name__ == "__main__":
    ...
    group=parser.add_argument("x", type=float, help="PFC_G")
    group=parser.add_argument("y", type=float, help="PFC_G_off")
