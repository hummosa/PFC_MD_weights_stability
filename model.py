...
class PFCMD():
    ...
    def train(self, data_gen):
        ...
        for traini in tqdm.tqdm(range(Ntrain)):
            ...
            # int(args_dict['switches']) #lengths_of_directed_trials[blocki - config.Nblocks +6] #200-(40*(blocki-config.Nblocks + 6)) #decreasing no of instructed trials
            config.no_of_trials_with_ofc_signal = 200
